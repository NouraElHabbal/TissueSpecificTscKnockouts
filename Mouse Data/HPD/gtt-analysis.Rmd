...
library(rjson)
library(RCurl)
#download data from experiment 808
itt_url <- 'http://bridgeslab.uthsc.edu/mousedb/api/v1/data/?format=json&username=davebridges&api_key=fce3fde2a9a2e5dc9e04c20aad90120a621c50b3&limit=0&experiment=808'
...
plot <- plot(times,
     ...
     las=1, ylim=c(0,ymax), ylab="Blood Glucose (mg/dL)", xlab="Insulin (min)", type="l", col='black')
#add other lines
...
kable(t.tests, caption="Pairwise t-tests for effects of diet at each point of the GTT, both for absolute and normalized values.")
```
