...
with(subset(mri_data_summary, Week<30&Knockout==F), superpose.eb(Week,Fat.Mass,Fat.Mass.se, col=c("#6CBE45","#FAC917")[1]))
with(subset(mri_data_summary, Week<30&Knockout==T), superpose.eb(Week,Fat.Mass,Fat.Mass.se, col=c("#6CBE45","#FAC917")[2]))

with(subset(mri_data_summary, Week<30&Knockout==T), points(Week,Fat.Mass, col=palette()[2], pch=19, cex=0.5))
legend("topleft", c("Wild-Type","Knockout"), bty="n", pch=19, col=c("#6CBE45","#FAC917"), lty=1)

with(subset(mri_data_summary, Week<30&Knockout==F), lines(smooth.spline(Fat.Mass ~ Week, spar=0.9), col=c("#6CBE45","#FAC917")[1]))
with(subset(mri_data_summary, Week<30&Knockout==T), lines(smooth.spline(Fat.Mass ~ Week, spar=0.9), col=c("#6CBE45","#FAC917")[2]))
```
...
with(subset(mri_data_summary, Week<30&Knockout==F), lines(smooth.spline(Fat.Mass ~ Week, spar=0.6), col=c("#6CBE45","#FAC917")[1]))
with(subset(mri_data_summary, Week<30&Knockout==T), lines(smooth.spline(Fat.Mass ~ Week, spar=0.6), col=c("#6CBE45","#FAC917")[2]))
```
