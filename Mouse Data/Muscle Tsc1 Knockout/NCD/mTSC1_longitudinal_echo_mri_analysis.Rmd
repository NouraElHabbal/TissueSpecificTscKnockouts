...
Based on a mixed linear model there was a significant effect of knockout reducing the accretion of fat mass (p=`r anova(fat.mass.lme,fat.mass.lme.null)$"Pr(>Chisq)"[2]`).
