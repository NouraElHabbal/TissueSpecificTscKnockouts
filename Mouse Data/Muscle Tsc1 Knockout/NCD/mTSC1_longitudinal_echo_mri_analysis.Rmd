...
legend("topleft", c("Wild-Type","Knockout"), bty="n", pch=19, col=c('black','grey50'), lty=1)

with(subset(mri_data_summary, Week<30&Knockout==F), lines(smooth.spline(Body.Weight ~ Week, spar=0.6),col=c('black','grey50')[1]))
with(subset(mri_data_summary, Week<30&Knockout==T), lines(smooth.spline(Body.Weight ~ Week, spar=0.6), col=c('black','grey50')[2]))
```
...
with(subset(mri_data_summary, Week<30&Knockout==T), lines(smooth.spline(Fat.Mass ~ Week, spar=0.9), col=c('black','grey50')[2]))
```
...
with(subset(mri_data_summary, Week<30&Knockout==T), lines(smooth.spline(Fat.Mass ~ Week, spar=0.6), col=c('black','grey50')[2]))
```
