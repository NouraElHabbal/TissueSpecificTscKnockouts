...
er_stress <- c('Xbp1','Atf4','Cebpe','Hspa5','Ddit3','Trib3')
irx_genes <- c('Irx3','Irx5')
ketosis_muscle <- c('Oxct1','Bdh1','Slc16a1','Slc16a7')
ketosis_receptors <- c('Hcar2','Ffar3')
ketone_body_generation <- c('Hmgcs2','Hmgcl','Bdh1','Slc16a6')
...
gene.data.name <- c('tsc_isoforms','glycogen_genes','pp1_regulatory_subunits','interleukins','srebp','linoleate_metabolism','myokines','tg_synthesis','lipolysis','oglnac_metabolisn','ribosomes','ppar_isoforms','b_oxidation','ppard_targets','myosin_heavy_chain','myosin_heavy_chain_main','slow_twitch_genes','fast_twitch_genes','myotubular_degradation','muscle_differentiation','autophagy','mitochondrial_genes','fatty_acid_uptake','fatty_acid_uptake_no_FABP3','fabp_cd36','cb_receptors','oxidative_markers_rosenbaum','serca','uncouplers','Jnk_related_genes','aa_transporters','aa_transporters_up','jnk_activators','hippo','guridi_genes','guridi_genes_2','FGF21_related','MitochondrialCalcium_genes','mitofusins','ca_reuptake','er_stress','irx_genes','ketosis_muscle','ketone_body_generation','ketosis_receptors','pfk_2_isoforms')
