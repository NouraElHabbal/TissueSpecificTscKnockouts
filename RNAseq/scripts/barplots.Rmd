...
genes.of.interest <- c("Tsc1",'Tsc2','Ppp1r3c','Cd36','Fabp3','Ucp3','Map3k9','Ppp1r15a','Slc38a1')
...
aa_transporters <- c(paste('Slc1a',seq(1,7), sep=""), paste('Slc3a',seq(1,2), sep="") ,paste('Slc7a',seq(1,14), sep="") ,paste('Slc36a',seq(1,4), sep=""),paste('Slc38a',seq(1,11), sep=""),paste('Slc43a',seq(1,5), sep=""))
aa_transporters_up <- c('Slc1a1','Slc1a2','Slc1a4','Slc3a1','Slc3a2','Slc7a1','Slc7a5','Slc7a6','Slc7a13','Slc38a1','Slc38a10','Slc43a2')
